module.exports.getCustomersByUserId = (userId, options) => {
  return {
    ...
    ProjectionExpression: 'fullName, last_trans_date,other_details,last_trans_amount,createdAt,address,email ,last_trans_id, balance, image, userId,id, phone, creditLimit',
